...
<body>
    <div class="login-container">
        <div class="image-container">
            <img src="{{ Storage::url('imager/user.png') }}" alt="Image de connexion">
        </div>
        <div class="form-container">
            ...
            <form action="{{route('user.store')}}" method="POST">
                ...
                <a href="/" class="return">logout</a><br/><br/>
                <a href="{{ route('comperuser.create') }}" class="create">Create an account</a>
            </form>
        </div>
    </div>
</body>
