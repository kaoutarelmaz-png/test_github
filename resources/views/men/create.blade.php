        ...
        <div class="col-md-12">
            <div class="card  " style="border: 0.5px solid gray">
                <div class="card-header  text-black py-3" style="background-color: #004d99;">
                    <h2 class="text-center mb-0 h5"  style="color: white;">
                        <i class="fas fa-plus-circle me-2"></i>Create New Product Men
                    </h2>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('men.store') }}" method="POST" enctype="multipart/form-data" id="productForm">
                        @csrf
                        <!-- Image Upload -->
                          <div class="row g-3">
                            <div class="col-md-6">
                                <label for="title" class="form-label fw-semibold">Code Product </label>
                                <input type="number" id="title" name="code_article_mens" class="form-control" 
                                       placeholder="Enter product code" required maxlength="255" style="border: 0.5px solid black;">
                                @error('code_article_mens')
