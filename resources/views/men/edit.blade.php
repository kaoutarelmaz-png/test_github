@extends('layouts.app')
@section('title','Update Product Men')
@section('content')
            ...
            <div class="card" style="border: 0.5px solid gray">
                <div class="card-header text-black py-3" style="background-color: #004d99; border-radius: 10px 10px 0 0;">
                    <h2 class="text-center mb-0 h5 text-white">
                        <i class="fas fa-edit me-2"></i>Edit Product Men
                    </h2>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('men.update', $edits->id) }}" method="POST" enctype="multipart/form-data" id="productForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-3"  style="margin-top: -40px;">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="code_article_mens" class="form-control" 
                                       value="{{ $edits->code_article_mens }}" required maxlength="255" style="border: 0.5px solid black;">
                            </div>
                        ...
                        <div class="row g-3 mt-2"  style="margin-top: 40px;">
                            <div class="col-md-6">
                        ...
                        <div class="row mt-3">
                            <div class="col-6">
                                <a href="{{ route('AffcherTableMen') }}" class="btn btn-outline-secondary w-100">
