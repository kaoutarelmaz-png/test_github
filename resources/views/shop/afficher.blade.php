...
<style>
    ...
    .stat-card {
        background: white;
        padding: 15px;  
        border-radius: 10px; /* زوايا أصغر */
        text-align: center;
        box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08); /* ظل أخف */
        border-left: 3px solid #023e8a; /* حدود أصغر */
...
<div class="products-management-container">
    ...
    <div class="page-header">
        ...
        <a href="{{ route('shop.create') }}" class="add-product-btn">
    ...
    <div class="stats-cards">
        <div class="stat-card">
            <div class="stat-number">{{ $shops->total() }}</div>
            <div class="stat-label">Total Products</div>
        </div>
        <div class="stat-card">
            <div class="stat-number">{{ number_format($shops->avg('price') ?? 0, 2) }} DH</div>
            <div class="stat-label">Average Price</div>
        </div>
        <div class="stat-card">
            <div class="stat-number">{{ $shops->sum('stock') }}</div>
            <div class="stat-label">Total Stock</div>
        </div>
        <div class="stat-card">
            <div class="stat-number">{{ $shops->unique('size')->count() }}</div>
                ...
                <tr class="product-row">
                    <td>
                        <span class="product-code">
                            {{ $shop->code_article_shops }}
                        </span>
                    </td>
                    <td>
                        <div class="product-title">{{ Str::limit($shop->title, 30) }}</div>
                    </td>
                    <td>
                        <span class="product-price">{{ number_format($shop->price, 2) }} DH</span>
                    </td>
                    <td>
                        <span class="product-size">{{ $shop->size }}</span>
                    </td>
                    <td>
                        @php
    ...
    <div class="pagination-container">
        <div class="custom-pagination">
            ...
            @else
                <a href="{{ $shops->previousPageUrl() }}"><i class="fas fa-chevron-left"></i> Previous</a>
            @endif
            ...
            @if ($shops->hasMorePages())
                <a href="{{ $shops->nextPageUrl() }}">Next <i class="fas fa-chevron-right"></i></a>
            @else
    ...
    <div class="empty-state">
        ...
        <a href="{{ route('shop.create') }}" class="add-product-btn" style="margin-top: 10px; padding: 10px;">
