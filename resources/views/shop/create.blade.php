        ...
        <div class="col-md-12">
            <div class="card  " style="border: 0.5px solid gray">
                <div class="card-header  text-black py-3">
                    <h2 class="text-center mb-0 h5">
                        <i class="fas fa-plus-circle me-2"></i>Create New Product Shop
                    </h2>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('shop.store') }}" method="POST" enctype="multipart/form-data" id="productForm">
                        @csrf
                        ...
                        <!-- Image Upload -->
                          <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" id="title" name="code_article_shops" class="form-control" 
