...
<body>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <a href="{{ route('shop.index') }}"><i class="fa fa-box"></i> Shop</a><br/>
    ...
    <div class="product-grid">
        @foreach ($womans as $woman)
            <div class="product-card">
                <img src="{{ Storage::url('imager/'.$woman->imager) }}" alt="{{ $woman->title }}">
                <div class="product-info">
                    <h4>{{ $woman->title }}</h4>
                    <p>{{ $woman->content }}</p>
                    <div class="price">${{ $woman->price }}</div>
                    <a href="{{ route('women.show',$woman->id) }}"><button class="add-to-cart">More</button></a>
                </div>
            </div>
        @endforeach
    </div>
