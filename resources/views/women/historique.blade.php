...
<head>
    <meta charset="UTF-8">
    <title>Historique des Produits Femmes</title>
...
<body style="background-color: #f8f9fa;">
    ...
    <div class="container mt-5">
        <h2 class="text-center mb-4">📜 Historique des modifications - Produits Femmes</h2>
        ...
        <table class="table table-bordered table-striped table-hover text-center">
            ...
            <tbody>
                @forelse ($historiques as $historique)
                    <tr>
                        <td>{{ $historique->code_article_womans }}</td>
